...
@end
@implementation GoodStoreItem2Cell
...
-(void)fullData:(GoodStoreModel*)goodStoreModel
{
    ...
    for(int i = 0; i < goods_list.count; i++){
        ...
        [btn addTarget:self action:@selector(goodStoreItem2SubViewClicked:) forControlEvents:UIControlEventTouchUpInside];
        btn.tag = 100+i;
    }
}


-(void)goodStoreItem2SubViewClicked:(UIButton*)btn
{
